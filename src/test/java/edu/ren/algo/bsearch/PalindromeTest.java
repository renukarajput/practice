...
public class PalindromeTest {
    ...
    public void numberOfCharsRequired1_0_0() {
        assertThat(new Palindrome().numberOfCharsRequired("AACBECAAAA"),is(6));
    }
    @Test
    public void numberOfCharsRequired1_0() {
        //AACECAAAA
        //CECAA
       // assertThat(new Palindrome().numberOfCharsRequired("AACECBBAA"),is(2));
    }
    ...
    public void numberOfCharsRequired5_0_4() {
        assertThat(new Palindrome().numberOfCharsRequired("qzbbqqa"),is(5));
    }
    @Test
