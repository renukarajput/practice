...
public class CandyDistributionTest {
    ...
    public void getMin() {
        Integer[] arr={1,2};
        assertThat(candyDistribution.getMin(arr),is(3));
    }

    @Test
    public void getMin_0() {
        Integer[] arr = {4, 6, 4, 5, 6, 2};
        assertThat(candyDistribution.getMin(arr), is(10));
    }

    @Test
    public void getMin_1() {
        Integer[] arr = {1, 2, 2};
        assertThat(candyDistribution.getMin(arr), is(4));
    }

    @Test
    public void getMin_01() {
        Integer[] arr = {5};
        assertThat(candyDistribution.getMin(arr), is(1));
    }
