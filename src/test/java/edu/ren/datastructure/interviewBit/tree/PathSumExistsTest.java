...
public class PathSumExistsTest {

    @Test
    public void sumExists() {
        int[] nodes1 = {5, 3, 4, 15, 13, 20};
        BinarySearchTree binarySearchTree = fromArray(nodes1);
        assertThat(new PathSumExists().sumExists(binarySearchTree,12),is(true));
    }
    ...
    public void sumExists_1() {
        int[] nodes1 = {5, 3, 4, 15, 13, 20};
        BinarySearchTree binarySearchTree = fromArray(nodes1);
        assertThat(new PathSumExists().sumExists(binarySearchTree,33),is(true));
    }
    @Test
    public void sumExists_2() {
        int[] nodes1 = {5, 3, 4, 15, 13, 20};
        BinarySearchTree binarySearchTree = fromArray(nodes1);
        assertThat(new PathSumExists().sumExists(binarySearchTree,40),is(true));
    }
    ...
    public void sumExists_missing() {
        int[] nodes1 = {5, 3, 4, 15, 13, 20};
        BinarySearchTree binarySearchTree = fromArray(nodes1);
        assertThat(new PathSumExists().sumExists(binarySearchTree,18),is(false));
    ...
    public void sumExists_missing_1() {
        int[] nodes1 = {5, 3, 4, 15, 13, 20};
        BinarySearchTree binarySearchTree = fromArray(nodes1);
        assertThat(new PathSumExists().sumExists(binarySearchTree,48),is(false));
    ...
    public void sumExists_missing_2() {
        int[] nodes1 = {5};
        BinarySearchTree binarySearchTree = fromArray(nodes1);
        assertThat(new PathSumExists().sumExists(binarySearchTree,6),is(false));
    ...
    public void sumExists_missing_3() {
        int[] nodes1 = {5};
        BinarySearchTree binarySearchTree = fromArray(nodes1);
        assertThat(new PathSumExists().sumExists(binarySearchTree,5),is(true));
    ...
    public void sum_1(){
        ...
        assertThat(new PathSumExists().sumExists(binarySearchTree, 21),is(true));
    }
