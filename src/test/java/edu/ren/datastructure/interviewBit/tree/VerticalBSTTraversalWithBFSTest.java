...
public class VerticalBSTTraversalWithBFSTest {


    BinarySearchTree fromArray(int[] nodes) {
    ...
    public void getVerticalNodeValues() {
        ...
        ArrayList<ArrayList<Integer>> verticalNodes = new VerticalBSTTraversalWithBFS().getVerticalNodeValues(fromArray(nodes));
